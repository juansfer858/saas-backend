...
assert.ok(lines80.some((line) => line.startsWith('Subtotal') && line.endsWith('$ 50.000')), 'Subtotal debe terminar alineado a la derecha');
assert.ok(lines80.some((line) => line.startsWith('Impoconsumo') && line.endsWith('$ 4.000')));
assert.ok(lines80.some((line) => line.startsWith('Propina') && line.endsWith('$ 5.000')));
assert.ok(lines80.some((line) => line.startsWith('TOTAL') && line.endsWith('$ 59.000')));
