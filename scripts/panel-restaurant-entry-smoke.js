...
// V5 is now rendered by the server before first paint. This is the single source of
// truth for sidebar color, icons, order and primary-vertical presentation.
...
// Browser runtime is intentionally NOT allowed to repaint, reorder or replace icons.
...
console.log('SUPER CORE V5 SERVER-OWNED SIDEBAR + NO-FLICKER REGRESSION SMOKE OK');