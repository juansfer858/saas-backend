...
console.log(JSON.stringify({ ok:true, module:'RESTAURANT_EMPLOYEES_V1', roles:['MESERO','COCINA','BARRA','POSTRES','CAJERO','ADMIN','CONTADOR'], deleteUsers:false, waiterDeviceShortcut:true }));
