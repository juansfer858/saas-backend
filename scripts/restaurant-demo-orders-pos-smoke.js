...
expect(runtime.includes("$('[data-demo-select]',wrap).forEach"), 'split selection bindings must use multi-selector helper');
expect(runtime.includes("$('[data-demo-qty]',wrap).forEach"), 'quantity bindings must use multi-selector helper');
expect(runtime.includes("$('[data-demo-remove]',wrap).forEach"), 'remove bindings must use multi-selector helper');
