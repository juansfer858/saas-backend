...
// El navegador solo vuelve a la URL firmada/validada que entrega Core.
...
// agente del tenant, TTL corto y nonce de un solo uso.
...
assert.match(edgeWorkspace, /nonce/);

// Edge instalado ya sabe consumir ese grant y crear la sesión local; por eso este
// arreglo es Core-only y no exige reinstalar 2.1.18.
...
console.log(JSON.stringify({
  ...
  existingOneTimeGrantReused: true,
