(() => {
  ...
  function ensureStyle() {
    ...
    style.textContent = `
      ...
      @media(max-width:700px){.vr-demo-modal{padding:0}.vr-demo-shell{width:100%;height:100dvh;border-radius:0}.vr-demo-head{height:58px}.vr-demo-title small{max-width:170px}.vr-demo-actions a{display:none}}
    `;
