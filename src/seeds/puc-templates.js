...
const PUC_CO = [
  ...
  { codigo: '15', nombre: 'Propiedades, planta y equipo', nivel: 'GRUPO', naturaleza: 'DEBITO', clasificacionESF: AN },
  ...
  { codigo: '24', nombre: 'Impuestos, gravámenes y tasas', nivel: 'GRUPO', naturaleza: 'CREDITO', clasificacionESF: P },
  ...
  { codigo: '26', nombre: 'Pasivos estimados y provisiones', nivel: 'GRUPO', naturaleza: 'CREDITO', clasificacionESF: PN },

  { codigo: '3', nombre: 'Patrimonio', nivel: 'CLASE', naturaleza: 'CREDITO', clasificacionESF: PT },
  { codigo: '31', nombre: 'Capital social', nivel: 'GRUPO', naturaleza: 'CREDITO', clasificacionESF: PT },
  { codigo: '3105', nombre: 'Capital suscrito y pagado', nivel: 'CUENTA', naturaleza: 'CREDITO', parent: '31', clasificacionESF: PT },
  { codigo: '36', nombre: 'Resultados del ejercicio', nivel: 'GRUPO', naturaleza: 'CREDITO', clasificacionESF: PT },
