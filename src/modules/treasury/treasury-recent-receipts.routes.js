...
async function listRecentReceipts(tenantId, { limit = 50 } = {}) {
...
router.get('/', async (req, res, next) => {
  try {
    const items = await listRecentReceipts(req.tenantId, { limit:req.query.limit });
...
module.exports = { treasuryRecentReceiptsRouter:router, paymentLabel, listRecentReceipts };
