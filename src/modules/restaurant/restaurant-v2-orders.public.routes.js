...
router.get('/app/restaurant-v2-orders-demo-pos-v1.css',(_req,res)=>send(res,'restaurant-v2-orders-demo-pos-v1.css','text/css; charset=utf-8'));
router.get('/app/restaurant-v2-person-buttons-v100.css',(_req,res)=>send(res,'restaurant-v2-person-buttons-v100.css','text/css; charset=utf-8'));
router.get('/app/restaurant-v2-orders.js',(_req,res)=>send(res,'restaurant-v2-orders.js','application/javascript; charset=utf-8'));
router.get('/app/restaurant-v2-orders-demo-pos-v1.js',(_req,res)=>send(res,'restaurant-v2-orders-demo-pos-v1.js','application/javascript; charset=utf-8'));
