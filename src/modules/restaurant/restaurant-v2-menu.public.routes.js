...
router.get('/app/restaurante-v2/carta', (_req,res)=>{
  const html=fs.readFileSync(path.join(webRoot,'restaurant-v2-menu.html'),'utf8').replace('</body>','<script src="/app/restaurant-promo-image-editor-v28.js?v=v28"></script></body>');
