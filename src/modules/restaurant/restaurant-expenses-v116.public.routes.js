...
;(()=>{
  ...
  window[MARKER]=Object.freeze({version:'116.0.0',basicExpenses:true,dailySalesXls:true});
  ...
  function allowed(){const role=String(auth()?.user?.rol||'').toUpperCase();return ['SUPERADMIN','ADMIN','CAJERO'].includes(role)}
