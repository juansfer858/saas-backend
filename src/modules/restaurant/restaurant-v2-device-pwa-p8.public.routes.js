...
// PWA start_url uses the trailing-slash form. Register both roots explicitly so
// no downstream /app fallback can canonicalize the request before P8 answers it.
