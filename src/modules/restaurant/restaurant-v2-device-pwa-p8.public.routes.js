...
router.get('/app/centro-de-control/mesero-v2',(_req,res)=>res.redirect(308,'/app/centro-de-control/mesero-v2/'));
router.get('/app/centro-de-control/mesero-v2/',(_req,res)=>{noStore(res);res.set('X-VantixGC-Restaurant-V2-Device','waiter-p8');res.type('text/html').sendFile(files.waiterHtml)});
...
router.get('/app/produccion-v2',(_req,res)=>res.redirect(308,'/app/produccion-v2/'));
router.get('/app/produccion-v2/',(_req,res)=>{noStore(res);res.set('X-VantixGC-Restaurant-V2-Device','production-p8');res.type('text/html').sendFile(files.productionHtml)});
