...
function fixPowerShell(source) {
  ...
  if (!fixed.includes(INSTALL_MANIFEST_PATH) || !fixed.includes('$StableCandidates = @()') || !fixed.includes('$ReleaseManifest.installRecommended')) {
    throw new Error('El instalador Windows no resuelve STABLE/recomendado desde el Core.');
  }
